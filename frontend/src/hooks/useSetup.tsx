...
import { SetupStatus, AdminCreateRequest, AdminCreateResponse, SetupCompleteRequest } from '../types/setup'
...
export function SetupProvider({ children }: { children: ReactNode }) {
  ...
  const createAdmin = useCallback(async (request: AdminCreateRequest): Promise<AdminCreateResponse> => {
    try {
      setLoading(true)
      setError(null)
  ...
  const completeSetup = useCallback(async (request: SetupCompleteRequest) => {
    try {
      setLoading(true)
      setError(null)
