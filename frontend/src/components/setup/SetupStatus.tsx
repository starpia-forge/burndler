  ...
  return (
    <div className="p-8">
      <div className="text-center mb-8">
        <InformationCircleIcon className="h-16 w-16 text-primary-600 mx-auto mb-4" />
        <h2 className="text-2xl font-bold text-foreground mb-2">System Status Check</h2>
      ...
      {setupStatus.requires_setup && (
        <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 mb-6">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-primary-foreground">Setup Required</h3>
