...
import { Module, ModuleFilters as ModuleFiltersType } from '../../types/module';
...
interface ModuleListProps {
  ...
  onDeleteModule?: (module: Module) => Promise<void>;
  onRefresh?: () => void;
  className?: string;
}
...
export const ModuleList: React.FC<ModuleListProps> = ({
  ...
  const handleDeleteModule = async (module: Module) => {
    ...
    try {
      ...
      setDeleteError(error.message || 'Failed to delete module');
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Manage your Docker Compose modules and versions
          </p>
        </div>
